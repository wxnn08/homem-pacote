...
\textbf{Lucas Eduardo Gonçalves da Rosa}: Organização de tarefas, organização do código, montagem do diagrama de classes no formato UML, revisão do código e revisão do relatório.
